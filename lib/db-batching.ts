...
export const DEFAULT_MIX_DESIGNS: MixDesign[] = [
  ...
  {
    id: "mix_c_3750_mx_50_50",
    code: "C-3750-MX-50-50",
    description: "CHUTE 3750 MIX",
    strength: "3750 PSI",
    placementType: "Direct Chute",
    cement: 260,
    sand: 850,
  ...
  },
  {
    id: "mix_p_3000",
    code: "P-3000",
    description: "PUMP 3000",
    strength: "3000 PSI",
    placementType: "Pump",
    cement: 230,
    sand: 940,
    threeQuarterStone: 615,
    threeEighthStone: 0,
    designWater: 121,
    plasticizer: 345,
    retarder: 460,
  ...
  {
    id: "mix_p_3000_mx_25_75",
    code: "P-3000-MX-25-75",
    description: "PUMP 3000 MIX",
    strength: "3000 PSI",
    placementType: "Pump",
    cement: 240,
    sand: 915,
  ...
  {
    id: "mix_p_3500_mx_50_50",
    code: "P-3500-MX-50-50",
    description: "PUMP 3500 MIX",
    strength: "3500 PSI",
    placementType: "Pump",
    cement: 250,
    sand: 835,
  ...
  {
    id: "mix_p_3750_mx_50_50",
    code: "P-3750-MX-50-50",
    description: "PUMP 3750 MIX",
    strength: "3750 PSI",
    placementType: "Pump",
    cement: 260,
    sand: 798,
  ...
  {
    id: "mix_p_4000_mx_50_50",
    code: "P-4000-MX-50-50",
    description: "PUMP 4000 MIX",
    strength: "4000 PSI",
    placementType: "Pump",
    cement: 290,
    sand: 815,
  ...
  {
    id: "mix_p_3000_campbell",
    code: "P-3000-CAMPBELL",
    description: "CAMPBELL 3000",
    strength: "3000 PSI",
    placementType: "Pump",
    cement: 236,
    sand: 830,
...
export async function seedInitialData() {
  ...
  if (obsCount === 0) {
    ...
    await tx.store.put({ id: "obs_vol_low", label: "Volume appears too low", isNormal: false, sortOrder: 10, active: true });
    await tx.store.put({ id: "obs_vol_high", label: "Volume appears to high (spilling from truck)", isNormal: false, sortOrder: 11, active: true });
    await tx.done;
  }
